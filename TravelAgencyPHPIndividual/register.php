    ...
    <form method="post" action="insertagent.php">
        <table class="table1">
            <tr class="tr1">
                ...
                <td class="td1"><input type="text" name="AgtFirstName" id="fname" placeholder="First Name" required /></td>
            </tr>
            <tr class="tr1">
                <td class="td1"><label for="lname">Last Name:</label></td>
                <td class="td1"> <input type="text" name="AgtLastName" id="iname" placeholder="Last Name" required /></td>
            </tr>
            <tr class="tr1">
            ...
            <tr class="tr1">
                ...
                <td class="td1"> <input type="text" name="Agtemail" id="email" placeholder="abc@xyz.com" required /></td>
            </tr>
            <tr class="tr1">
                <td class="td1"><label for="cellphone">Cellphone:</label></td>
                <td class="td1"> <input type="text" name="AgtBusPhone" id="cellphone" placeholder="Cellphone" required /></td>
            </tr>
            <tr class="tr1">
